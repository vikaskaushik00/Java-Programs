...
public class Main {
    ...
    Album album = new Album("Punjabi hits","Karan Aujla");
    album.add("Hint",03.45);
    album.add("Don't Look",04.25);
    album.add("Na Na Na",04.35);
    album.add("Ink",04.00);
    albums.add(album);

    album = new Album("BollyWood ","Arijit");
    album.add("Pachtaoge",03.45);
    album.add("Tera fitoor",04.45);
    album.add("Sanam re",04.45);
    albums.add(album);
